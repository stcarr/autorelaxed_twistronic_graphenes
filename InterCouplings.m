...
classdef InterCouplings < handle
    ...
    methods
        ...
        function relax_configs_NPK(obj, relax_str, AA_angle, AA_distance, AB_angle, AB_buffer_distance, AB_smooth_distance)
            ...
            for o1 = 1:norbs
                for o2 = 1:norbs
                    ...
                    atom_pos_list = [D(:,1)';D(:,2)';z];
                    y_arm = supercell*L(:,1);
                    x_arm = supercell*(L(:,1)-2*L(:,2));
                    cellDimXY = [x_arm(1) y_arm(2)];
                    plotrotfield = false;

                    u_relax_h = -relax_str*relax_geom_NPK(AA_angle, AA_distance, AB_angle, AB_buffer_distance, AB_smooth_distance, atom_pos_list(1:2,:)', cellDimXY, plotrotfield);

                    Bx(o1,o2,:) = x + u_relax_h(:,1);
                    By(o1,o2,:) = y + u_relax_h(:,2);
                    Bz(o1,o2,:) = z';
                    u_rlx(o1,o2,:,:) = u_relax_h;
                end
            end
        ...
        function gen_tK(obj,AA_str,AB_str)
